...
describe("Validate SampleAPI", function () {
    ...
    it("invalid request", async function () {
        sinon.stub(service, 'FirstAPI').resolves({
    ...
    it("Create success,but associate failed", async function () {
        ...
        sinon.stub(service, 'SecondAPI').resolves({
    ...
    it("Only associate", async function () {
        ...
        callback.onCall(4).resolves({
            error: null,
            response: {
                statusCode: 204
            }
        });
        callback.onCall(5).resolves({
            error: null,
            response: {
                statusCode: 204
            }
